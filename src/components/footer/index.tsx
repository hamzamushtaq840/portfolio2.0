...
const Footer = () => {
  return (
    <div className="pb-4 lg:pb-1">
      <div className="m-4 mb-0 flex flex-col justify-between rounded-lg bg-black px-8 py-10 lg:m-12 lg:mb-8 lg:flex-row lg:px-56 lg:py-20">
